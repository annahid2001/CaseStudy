...
clean: 	
	rm -f GDP.csv Edu.csv GDP_Clean.csv Edu_Clean.csv Rplots.pdf Case.html
...
Analysis: Analysis.R clean_data load_libraries import_data 
	Rscript $<

#Rule to produce RMarkdown file for reporting	
Case.html: Case.Rmd Analysis 
